...
public interface Game
{
	...
	public static final float GHOST_REVERSAL=0.0000f;		//probability of a global ghost reversal event
	...
	// New Functions
	public int getNodeUsingXY(int x, int y);                         // returns the NodeIndex using the X and Y co-ordinate or nearest valid Node-index
}