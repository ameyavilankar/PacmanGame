...
//		exec.runExperiment(new RandomPacMan(),new MyGhosts(true),100);
		
		//run game without time limits (un-comment if required)
//		exec.runGame(new RandomPacMan(),new MyGhosts(true),true,G.DELAY);
		...
		//exec.runGameTimedAndRecorded(new Human(),new MyGhosts(true),true,"human-v-Legacy2.txt");
